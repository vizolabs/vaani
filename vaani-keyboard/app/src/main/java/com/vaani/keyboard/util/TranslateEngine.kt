...
object TranslateEngine {
    ...
    private val phrasebook: Map<String, String> = buildMap {
        ...
        put("time kya hai", "What is the time")
        put("kitne baje hain", "What is the time")
        put("do baje", "At two o'clock")
        put("teen baje", "At three o'clock")
        put("chaar baje", "At four o'clock")
        put("paanch baje", "At five o'clock")
        put("aath baje", "At eight o'clock")
        put("nau baje", "At nine o'clock")
        put("das baje", "At ten o'clock")
        put("aadha ghanta", "Half an hour")
        put("ek ghanta", "One hour")
        put("do ghante", "Two hours")
        put("teen ghante", "Three hours")
        put("aadha ghanta lagta hai", "It takes half an hour")
        put("pune ghanta", "One full hour")
        put("sawa ghanta", "One and a quarter hours")
        put("sade teen baje", "At half past three")
        put("pavan baje", "At a quarter past")
        put("sava gyarah baje", "At quarter past eleven")
        put("pune do baje", "At two o'clock sharp")
        put("der raat tak", "Until late night")
        put("subah jaldi", "Early morning")
        put("sham tak", "By evening")
        put("raat tak", "By night")
        put("pichhli raat", "Last night")
        put("aaj subah", "This morning")
        put("aaj dopahar", "This afternoon")
        put("aaj shaam", "This evening")
        ...
        put("girlfriend", "Girlfriend")
        put("mangetar", "Fiancé")
        put("dulha", "Groom")
        put("dulhan", "Bride")
        put("saheli", "Friend (female)")
        put("dost dost", "Close friends")
        ...
        put("kuch khane ko hai", "Is there something to eat")
        put("kuch pine ko hai", "Is there something to drink")
        put("order karo", "Place an order")
        put("order de do", "Place an order")
        put("menu dikhao", "Show me the menu")
        put("kya special hai", "What is the special dish")
        put("aapki recommendation kya hai", "What is your recommendation")
        put("spicy nahi chahiye", "I do not want it spicy")
        put("extra cheese dalo", "Add extra cheese")
        put("extra masala dalo", "Add extra spices")
        put("pizza order karo", "Order a pizza")
        put("burger khaana hai", "I want to eat a burger")
        put("momos khaane hain", "I want to eat momos")
        put("plate dhulai karo", "Wash the plates")
        put("table book karo", "Book a table")
        put("table reserve karo", "Reserve a table")
        put("kya veg hai", "What is vegetarian")
        put("kya nonveg hai", "What is non-vegetarian")
        put("anda kha lo", "Eat an egg")
        put("doodh pi lo", "Drink milk")
        put("doodh garam karo", "Heat the milk")
        put("juice nikaal lo", "Extract the juice / Have juice")
        put("pakode banao", "Make pakoras")
        put("chai mein shakkat daalo", "Add sugar to the tea")
        put("mirchi kam dalo", "Add less chili")
        put("namak kam hai", "There is less salt")
        put("kuch mitha kha lo", "Eat something sweet")
        put("khane ka time ho gaya", "It is time to eat")
        put("kya banau aaj", "What should I cook today")
        put("kya banao", "What are you cooking")
        put("swadisht bana hai", "It is cooked deliciously")
        put("kachcha hai", "It is raw")
        put("jala hua hai", "It is burnt")
        put("zayka achha hai", "The flavor is good")
        put("khane mein kya hai", "What is in the food")
        put("chawal kha lo", "Eat the rice")
        put("dal chawal kha lo", "Eat lentils and rice")
        put("sabji kha lo", "Eat the vegetables")
        put("salad banao", "Make a salad")
        put("fruit kha lo", "Eat fruits")
        ...
        put("hotel book karo", "Book a hotel")
        put("room book karo", "Book a room")
        put("ticket book karo", "Book a ticket")
        put("flight book karo", "Book a flight")
        put("train book karo", "Book a train")
        put("checkin karo", "Check in")
        put("checkout karo", "Check out")
        put("checkin ka time kya hai", "What is the check-in time")
        put("checkout ka time kya hai", "What is the check-out time")
        put("saman pack karo", "Pack your luggage")
        put("saman utha lo", "Pick up your luggage")
        put("saman sambhal lo", "Take care of your luggage")
        put("kab nikalna hai", "When should we leave")
        put("kab pahunchenge", "When will we reach")
        put("kab pahunchunga", "When will I reach")
        put("kitna samaan hai", "How much luggage is there")
        put("auto bulao", "Call an auto rickshaw")
        put("taxi bulao", "Call a taxi")
        put("cab bulao", "Call a cab")
        put("ola book karo", "Book an Ola")
        put("uber book karo", "Book an Uber")
        put("kya metro jaati hai yahan se", "Does the metro go from here")
        put("kya bus jaati hai yahan se", "Does the bus go from here")
        put("metro station kahan hai", "Where is the metro station")
        put("bus stop kahan hai", "Where is the bus stop")
        put("platform number kya hai", "What is the platform number")
        put("kahaan utarna hai", "Where to get off")
        put("agla station kya hai", "What is the next station")
        put("ticket kahan milega", "Where can I get a ticket")
        put("online ticket milta hai", "The ticket is available online")
        put("safar achha raha", "The journey was good")
        put("safari achhi gayi", "The trip went well")
        ...
        put("excited hoon", "I am excited")
        put("excited hoon bahut", "I am very excited")
        put("nervous ho raha hoon", "I am feeling nervous")
        put("confident hoon", "I am confident")
        put("hopeful hoon", "I am hopeful")
        put("confused hoon", "I am confused")
        put("confuse ho gaye", "Got confused")
        put("satisfied hoon", "I am satisfied")
        put("proud hoon", "I am proud")
        put("proud feel ho raha hai", "I am feeling proud")
        put("ashcharya ho raha hai", "I am surprised")
        put("surprise ho gaye", "Got surprised")
        put("shock ho gaye", "Got shocked")
        put("jealous ho rahe ho", "You are getting jealous")
        put("iriya ho rahi hai", "I am feeling jealous")
        put("relief mil gaya", "Felt relieved")
        put("bura lag raha hai", "I am feeling bad")
        put("achha lag raha hai", "I am feeling good")
        put("ajib lag raha hai", "It feels strange")
        put("akela feel ho raha hai", "I am feeling lonely")
        put("alone feel kar raha hoon", "I am feeling alone")
        put("thankful hoon", "I am thankful")
        put("grateful hoon", "I am grateful")
        put("blessed feel kar raha hoon", "I am feeling blessed")
        ...
        put("khoon check karo", "Get a blood test")
        put("blood test karwana hai", "I need to get a blood test done")
        put("x-ray karwana hai", "I need to get an X-ray done")
        put("ultrasound karwana hai", "I need to get an ultrasound done")
        put("ppe ka dard hai", "I have back pain")
        put("kamar mein dard hai", "I have back pain")
        put("pair mein dard hai", "My leg hurts")
        put("haath mein dard hai", "My hand hurts")
        put("gale mein dard hai", "I have a sore throat")
        put("gale mein kharaash hai", "I have a scratchy throat")
        put("khaansi bahut hai", "I have a bad cough")
        put("bukhar utar gaya", "The fever went down")
        put("bukhar barh gaya", "The fever increased")
        put("naak beh rahi hai", "My nose is running")
        put("naak band hai", "My nose is blocked")
        put("sans lene mein takleef hai", "I have difficulty breathing")
        put("elergy hai", "I have an allergy")
        put("infection ho gaya", "Got an infection")
        put("haath kat gaya", "My hand got cut")
        put("pair mei chubh gaya", "Something pierced my foot")
        put("suujh gaya", "It got swollen")
        put("suujh gayi", "It got swollen")
        put("moch aa gayi", "Got a sprain")
        put("hadh tod di", "Broke a bone")
        put("fracture ho gaya", "Got a fracture")
        put("dawai khane ka time ho gaya", "It is time for the medicine")
        put("dawai bhool gaye", "Forgot to take the medicine")
        put("operation karna hai", "I need to have a surgery")
        put("nashadard ki dawai", "Painkiller medicine")
        put("neend nahi aa rahi", "I am unable to sleep")
        put("thanda paani pi lo", "Drink cold water")
        put("gargle karo", "Gargle")
        put("aaram karo", "Take rest")
        put("bed rest karo", "Take bed rest")
        ...
        put("try karo", "Try it on")
        put("trial lo", "Take a trial")
        put("size ka hai", "What size is it")
        put("ye size nahi hai", "This is not the right size")
        put("aur dikhao", "Show me more")
        put("aur kuch dikhao", "Show me something else")
        put("kachha maal hai", "It is raw material")
        put("pakka maal hai", "It is good quality")
        put("quality achhi hai", "The quality is good")
        put("quality kharab hai", "The quality is bad")
        put("branded hai", "It is branded")
        put("cash do", "Pay by cash")
        put("card se do", "Pay by card")
        put("upi karo", "Pay by UPI")
        put("gpay karo", "Pay by Google Pay")
        put("phonepay karo", "Pay by PhonePe")
        put("qr code scan karo", "Scan the QR code")
        put("batcha baki hai", "There is change remaining")
        put("paisa wapas do", "Return the money")
        put("refund do", "Give a refund")
        put("exchange karo", "Exchange it")
        put("bill le lo", "Take the bill")
        put("gift wrap karo", "Gift wrap it")
        put("sale hai kya", "Is there a sale going on")
        put("offer hai kya", "Is there an offer")
        put("buy one get one hai", "Is it buy one get one")
        ...
        put("status daal do", "Post a status")
        put("status dekh lo", "View the status")
        put("status update karo", "Update your status")
        put("story daali", "Posted a story")
        put("story dekh lo", "View the story")
        put("instagram pe daal do", "Post it on Instagram")
        put("instagram pe dekh lo", "Check it on Instagram")
        put("facebook pe daal do", "Post it on Facebook")
        put("youtube pe daal do", "Upload it on YouTube")
        put("youtube pe dekh lo", "Watch it on YouTube")
        put("subscribe karo", "Subscribe")
        put("like karo", "Like it")
        put("share karo", "Share it")
        put("comment karo", "Comment")
        put("follow karo", "Follow")
        put("notification aaya", "Got a notification")
        put("notification nahi aaya", "Did not get a notification")
        put("app download karo", "Download the app")
        put("app update karo", "Update the app")
        put("app delete karo", "Delete the app")
        put("screen record karo", "Record the screen")
        put("screenshot le lo", "Take a screenshot")
        put("viral ho gaya", "It went viral")
        put("trending hai", "It is trending")
        put("reel banao", "Make a reel")
        put("short video banao", "Make a short video")
        put("go viral ho", "Go viral")
        put("google pe search karo", "Search it on Google")
        put("online milta hai", "It is available online")
        ...
        put("barish ruk gayi", "The rain stopped")
        put("barish aane wali hai", "Rain is about to come")
        put("dhoop nikal gayi", "The sun came out")
        put("dhoop nahi hai", "There is no sun")
        put("thand barh gayi", "The cold increased")
        put("garmi barh gayi", "The heat increased")
        put("mausam badal gaya", "The weather changed")
        put("mausam sukha hai", "The weather is dry")
        put("mausam nam hai", "The weather is humid")
        put("umid hai", "There is humidity")
        put("toofan aane wala hai", "A storm is coming")
        put("aandhi aayi", "A storm came")
        put("bhol chal rahi hai", "It is hailing")
        put("barish mein bheeg gaye", "Got wet in the rain")
        put("chhata le lo", "Take an umbrella")
        put("raincoat pehen lo", "Wear a raincoat")
        put("mausam saaf hai", "The weather is clear")
        put("indradhanush dikha", "A rainbow appeared")
        put("sitaare chamak rahe hain", "The stars are shining")
        put("chand nikal aaya", "The moon came out")
        put("chandni raat hai", "It is a moonlit night")
        ...
        put("happy raksha bandhan", "Happy Raksha Bandhan")
        put("raksha bandhan ki badhai", "Happy Raksha Bandhan")
        put("happy janmashtami", "Happy Janmashtami")
        put("janmashtami ki badhai", "Happy Janmashtami")
        put("happy navratri", "Happy Navratri")
        put("navratri ki badhai", "Happy Navratri")
        put("happy maha shivratri", "Happy Maha Shivratri")
        put("happy ganesh chaturthi", "Happy Ganesh Chaturthi")
        put("ganesh chaturthi ki badhai", "Happy Ganesh Chaturthi")
        put("happy dussehra", "Happy Dussehra")
        put("dussehra ki badhai", "Happy Dussehra")
        put("happy eid ul fitr", "Happy Eid ul Fitr")
        put("happy eid ul adha", "Happy Eid ul Adha")
        put("bakrid mubarak", "Happy Bakrid")
        put("happy lohri", "Happy Lohri")
        put("happy pongal", "Happy Pongal")
        put("happy onam", "Happy Onam")
        put("happy baisakhi", "Happy Baisakhi")
        put("happy makar sankranti", "Happy Makar Sankranti")
        put("happy guru nanak jayanti", "Happy Guru Nanak Jayanti")
        put("happy buddha jayanti", "Happy Buddha Jayanti")
        put("happy mahavir jayanti", "Happy Mahavir Jayanti")
        put("happy holi", "Happy Holi")
        put("happy diwali", "Happy Diwali")
        put("happy christmas", "Happy Christmas")
        put("happy new year", "Happy New Year")
        put("anniversary mubarak", "Happy Anniversary")
        put("anniversary ki badhai", "Happy Anniversary")
        put("engagement mubarak", "Congratulations on your engagement")
        put("shadi mubarak", "Congratulations on your wedding")
        put("naukri lagne ki badhai", "Congratulations on your new job")
        put("promotion mubarak", "Congratulations on your promotion")
        put("baby boy ki badhai", "Congratulations on your baby boy")
        put("baby girl ki badhai", "Congratulations on your baby girl")
        put("naye ghar ki badhai", "Congratulations on your new home")
        put("pass ho gaye ki badhai", "Congratulations on passing")
        put("jiti ki badhai", "Congratulations on winning")
    ...
    private val templates: List<Pair<Regex, (MatchResult) -> String>> = listOf(
        ...
        // "kya aapne {X}" → "Did you {X}" (generic, keep at end)
